...
<?php
   ...
   $pathfile="pathfile=/home/ecostore/www/citelis/param/pathfile";
	...
	$path_bin = "/home/ecostore/www/citelis/bin/response";
  ...
  if (( $code == "" ) && ( $error == "" ) )
	...
	print("<center>\n");
	print("<H3>R&eacute;ponse manuelle du serveur CITELIS</H3>\n");
	print("</center>\n");
	print("<b><h4>\n");
	print("<br><hr>\n");
